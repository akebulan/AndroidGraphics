 ...
 *
 */
public abstract class AParser1 implements IParser {
	protected Resources resources;
	protected String resourceID;
	protected String packageID;
	protected String currentMaterialKey;
	protected ArrayList<ParseObjectData1> parseObjects;
	protected ParseObjectData1 co;
	...
	public AParser1()
	{
		...
		parseObjects = new ArrayList<ParseObjectData1>();
		textureAtlas = new TextureAtlas();
		firstObject = true;
		materialMap = new HashMap<String, Material>();
	}
	
	public AParser1(Resources resources, String resourceID, Boolean generateMipMap)
	{
		this();
	...
	protected class TextureAtlas {
		...
		public void addBitmapAsset(BitmapAsset ba) {
			...
			if(existingBA == null)
			{
				...
				Bitmap b = Utils1.makeBitmapFromResourceId(bmResourceID);
