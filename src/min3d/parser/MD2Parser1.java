...
public class MD2Parser1 extends AParser1 implements IParser {

    private MD2Header header;
    private String currentTextureName;
    private KeyFrame[] frames;

    public MD2Parser1(Resources resources, String resourceID, boolean generateMipMap) {
    ...
    public AnimationObject3d getParsedAnimationObject() {
        ...
        // needed for applying texture to model
