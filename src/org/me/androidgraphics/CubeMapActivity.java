...
public class CubeMapActivity extends Activity {
    ...
    private class Renderer implements GLSurfaceView.Renderer {
        ...
        private Grid mGrid,mGrid1,mGrid2,mGrid3,mGrid4,mGrid5;
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            mGrid1 = generateTorusGrid(gl, 60, 60, 2.0f, 0.75f);
            mGrid2 = generateTorusGrid(gl, 60, 60, 1.0f, 0.75f);
            mGrid3 = generateTorusGrid(gl, 60, 60, 2.5f, 0.75f);
            mGrid4 = generateTorusGrid(gl, 60, 60, 3.5f, 0.75f);
            mGrid5 = generateTorusGrid(gl, 60, 60, 1.5f, 0.75f);
