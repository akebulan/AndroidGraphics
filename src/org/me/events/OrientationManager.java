package org.me.events;

import org.me.androidgraphics.Orientation;
    ...
    public static boolean isSupported() {
        if (supported == null) {
            if (Orientation.getContext() != null) {
                sensorManager = (SensorManager) Orientation.getContext().getSystemService(Context.SENSOR_SERVICE);
    ...
    private static SensorEventListener sensorEventListener =
            new SensorEventListener() {
                ...
                public void onSensorChanged(SensorEvent event) {
                    ...
                    if (pitch < -5 && pitch > -135) {
                        // top side up
                        currentSide = Side.TOP;
                        listener.onTopUp();

                    } else if (pitch > 5 && pitch < 135) {
                        // bottom side up
