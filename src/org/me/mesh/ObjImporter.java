...
// face
                    ...
                    face.uv1 = uvs.get(Integer.valueOf(st.nextToken(SPACE).trim()) - 1);
                    face.v2 = verticies.get(Integer.valueOf(st.nextToken(SLASH).trim()) - 1);
                    face.uv2 = uvs.get(Integer.valueOf(st.nextToken(SPACE).trim()) - 1);
                    face.v3 = verticies.get(Integer.valueOf(st.nextToken(SLASH).trim()) - 1);
                    face.uv3 = uvs.get(Integer.valueOf(st.nextToken(SPACE).trim()) - 1);
                    faces.add(face);
                }
            }
...
//printFaces(faces);
        ...
        data.vertices = new float[facesSize * 3 * 3];
